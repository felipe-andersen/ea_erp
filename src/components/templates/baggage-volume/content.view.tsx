...
'use client'
import { X, Bell, MessageSquareIcon, MoveRight, EllipsisVertical, Key, Table, List, Filter, Sidebar, FilterIcon, ChevronDown, ChevronDownIcon, ChevronDownSquareIcon} from "lucide-react";
        ...
        <div className='w-full h-auto w-full sm:p-8 flex flex-col bg-white'>
            <div className='flex justify-between '>
                ...
                <span className="flex gap-3 items-center h-10">
                    ...
                    >
                        <span>Volume de bagagem padrão</span>
